...
role :web, "188.166.248.144"                          # Your HTTP server, Apache/etc
role :app, "188.166.248.144"                         # This may be the same as your `Web` server
role :db,  "188.166.248.144"   , :primary => true # This is where Rails migrations will run
